...
void main(void) {
	lensDistance = (vec2(position.x*swidth, position.y*sheight) - vec2(lens_xoffset, lens_yoffset))*0.5;
	arrayDistance = (vec2(position.x*swidth, position.y*sheight) - vec2(lens_xoffset+array_xoffset, lens_yoffset))*0.5;
